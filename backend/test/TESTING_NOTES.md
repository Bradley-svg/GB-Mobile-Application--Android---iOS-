...
- Local runs: set `TEST_DATABASE_URL` (you can reuse your dev Postgres or a dedicated test DB). The seed inserts a demo org/site/device/user and ensures schema from `sql/*.sql` is present.
