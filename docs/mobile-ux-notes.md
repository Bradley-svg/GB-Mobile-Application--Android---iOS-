...
- Branding: screens use the Greenbro palette (brandGreen #39B54A, brandGrey #414042, textPrimary #111111, textSecondary #555555, background #FFFFFF, backgroundAlt #F5F7F9, border #E1E5EA, error #DC2626, warning #D97706, success #16A34A) with gradients.brandPrimary (#39B54A -> #2D9C3E). Horizontal logo sits on auth/login and Dashboard header; tabs, pills, and chips use brandGreen for active states and muted greys when inactive.
...
- Palette (from `mobile/app/theme/colors.ts`): brandGreen #39B54A, brandGrey #414042, textPrimary #111111, textSecondary #555555, background #FFFFFF, backgroundAlt #F5F7F9, borderSubtle #E1E5EA, error #DC2626, warning #D97706, success #16A34A; gradients: brandPrimary (#39B54A -> #2D9C3E), brandSoft (#E9F7EC -> #FFFFFF).
- Logo sources: `docs/branding/official/` (approved originals) with shipped app assets in `mobile/assets/greenbro/` (`greenbro-logo-horizontal.png`, `greenbro-icon-1024.png`, `greenbro-splash.png`).
