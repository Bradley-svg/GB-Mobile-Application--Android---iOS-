...
- **RBAC**: UI now mirrors backend roles; contractors see read-only states for control, exports, sharing, and work-order edits instead of actions that will be denied.
