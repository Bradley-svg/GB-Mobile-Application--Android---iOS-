...
- Demo tenant: `DEMO_EMAIL`/`DEMO_PASSWORD` (seeded owner login), `DEMO_ORG_ID` (defaults to `1111…1111`), `DEMO_DEVICE_MAC` (defaults to `38:18:2B:60:A9:94` for history alignment).
...
## Staging
- Base: `NODE_ENV=production`, `APP_VERSION=0.8.0`, `PORT=4000`, `WEB_ALLOWED_ORIGINS` / `CORS_ALLOWED_ORIGINS` listing staging web/app origins.
...
- Demo tenant: set `DEMO_EMAIL=demo@greenbro.com`, `DEMO_PASSWORD=<staging-demo-pass>`, `DEMO_ORG_ID=1111…1111`, `DEMO_DEVICE_MAC=38:18:2B:60:A9:94` to match the seeded org/user/device.
...
- Demo tenant: set `DEMO_EMAIL=demo@greenbro.com`, `DEMO_PASSWORD=<prod-demo-pass>`, `DEMO_ORG_ID=1111…1111`, `DEMO_DEVICE_MAC=38:18:2B:60:A9:94` if a shared demo tenant is required.
