...
- [ ] Push: registration error-free; Diagnostics “Send test notification” produces an OS notification; tapping from background lands in Alert/Device (or inside the app).
