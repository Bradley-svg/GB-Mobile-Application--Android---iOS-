...
- [ ] `.env`/secrets populated for the target environment (dev/staging/prod) with:
  ...
  - Alerts worker: `ALERT_OFFLINE_MINUTES`, `ALERT_OFFLINE_CRITICAL_MINUTES`, `ALERT_HIGH_TEMP_THRESHOLD`, `ALERT_WORKER_INTERVAL_SEC`, `WORKER_LOCK_TTL_SEC`, `ALERT_WORKER_ENABLED`
